...
CLIENT_ID = 'jc3cf979lo0u988t1vehi3kjer09g9zq'  # Insert Box client ID here
CLIENT_SECRET = 'vTRXsg2ZlnfGShKi71KsDGfgnGFZ9fQP'  # Insert Box client secret here
...
def authenticate(oauth_class=OAuth2):
    ...
    local_server = StoppableWSGIServer(host='localhost', port=8094)
    ...
    auth_url, csrf_token = oauth.get_authorization_url('http://localhost:8094')
